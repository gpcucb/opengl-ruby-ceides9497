...
def display
  ...
  glBegin(GL_TRIANGLES)
    ...
    glVertex3f(0.0,0.8,0.0) #coordenadas del primer vector
    glColor3f(0.0,1.0,0.0) #Color del segundo vertice
    glVertex3f(-0.6,-0.2,0.0) #coordenadas del segundo vector
